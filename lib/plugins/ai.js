/*
* Written with guidance from [ Meysman, Arno and Davy Cielen.
* HTML5 Game Development with ImpactJS. Packt, 2013. ]
* */
    ...
    defines(function(){
        ig.ai = ig.Class.extend({
            ...
            getAction: function(entity){
                ...
                if( res.collision.x){
                    if(angle > 0){return this.doAction(ig.ai.ACTION.MoveUp);}else{return this.doAction(ig.ai.ACTION.Rest);}
                }
                if(res.collision.y){
                ...
                if(distance < 15){
                    ...
                    if(decide < 0.3){return this.doAction(ig.ai.ACTION.Attack);}
                ...
                if( distance > 15 && distance < 40) {
                    ...
                    if(angle < 0){return this.doAction(ig.ai.ACTION.Rest);}
                    return this.doAction(ig.ai.ACTION.Rest);
                }
                return this.doAction(ig.ai.ACTION.Rest);
            }
