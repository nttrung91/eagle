...
MyGame = ig.Game.extend({
    ...
    // Health Bar
    healthBarSprite: new ig.Image('media/bullet.png'),
	...
	init: function() {
        ...
        var play_music = true;
        var music = ig.music;
        music.add("media/audio/2-04 Run!.*");
        music.volume = 0.7;
        music.play();

        //sound effects
        //var sound = new ig.Sound( 'media/audio/GUN_FIRE-GoodSoundForYou-820112263.mp3' );
	...
	draw: function() {
        ...
        /* Draw Health Bar */
        for(var k=0; k < player.health; k++){
            this.healthBarSprite.draw(5, ((this.healthBarSprite.height + 2) * k)+ 40);
        }
	},
