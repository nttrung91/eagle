ig.module(
    ...
    .defines(function() {
        EntityPlayer = ig.Entity.extend({
            ...
            //audio sfx
            gunSFX: new ig.Sound( 'media/audio/gun.mp3' ),
...
/*=======
                ...
                //turn off invincibility when timer runs out
...
>>>>>>> ahoshino*/
            ...
            /*
             ...
             |--------------------------------------------------------------------------
             | Makes player temporarily invincible. Used for initial character spawn.
             */
            makeInvincible: function(){
            ...
            receiveDamage: function( amount, from) {
                ...
                if(this.invincible)
                    return;
                this.parent(amount, from); ///ARBITRARY 10
            },
